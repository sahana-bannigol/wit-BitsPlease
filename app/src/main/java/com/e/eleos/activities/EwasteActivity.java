...
public class EwasteActivity extends AppCompatActivity {
    ...
    private Chip chip_wire,chip_battery,chip_phone,chip_tubelight,chip_other;
    private TextView tv_coordinates;
    private EditText et_noofpppl;
    private ToggleButton toggle_pickup;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        chip_battery = (Chip) findViewById(R.id.chip_battery);
        chip_wire = (Chip) findViewById(R.id.chip_wire);
        chip_phone = (Chip) findViewById(R.id.chip_phone);
        chip_tubelight = (Chip) findViewById(R.id.chip_tubelight);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (flag) {
                    ...
                    if (ActivityCompat.checkSelfPermission(EwasteActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(EwasteActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(chip_battery.isChecked()) list.add("battery");
                if(chip_phone.isChecked()) list.add("phone");
                if (chip_wire.isChecked()) list.add("wire");
                if(chip_tubelight.isChecked()) list.add("tubelight");
                ...
                firebaseFirestore.collection("ewastedonate").add(donateFood)
                        .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                            @Override
                            public void onSuccess(DocumentReference documentReference) {
                                documentReference.update("documentId",documentReference.getId());
                                AlertDialog.Builder alertBuilder2= new AlertDialog.Builder(EwasteActivity.this);
